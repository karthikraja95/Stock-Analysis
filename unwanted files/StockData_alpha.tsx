  ...
  return (
    <motion.div className="card" whileHover={{ scale: 1.05 }}>
      ...
      <div className="grid grid-cols-2 gap-2">
        <MetricItem label="Market Cap" value={`$${parseFloat(data.MarketCapitalization).toLocaleString()}`} />
  ...
  return (
    <motion.div className="card" whileHover={{ scale: 1.05 }}>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <MetricItem label="P/CF Ratio" value={data.PriceCashFlowRatio} />
    ...
    <motion.div className="card" whileHover={{ scale: 1.05 }}>
      ...
      <div className="grid grid-cols-2 gap-2">
        <MetricItem 
          ...
          value={formatPercentage(data.EarningsGrowth)} 
        />
        <MetricItem 
        ...
        <MetricItem 
          ...
          value={formatCurrency(data.FreeCashFlow)} 
        />
        <MetricItem 
          label="Dividend Payout" 
          value={formatPercentage(data.PayoutRatio)} 
        />
      </div>
    </motion.div>
  )
